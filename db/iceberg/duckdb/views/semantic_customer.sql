...
-- the ${BRAND_PREDICATE} seam (withServingBrand → brand_id = ?) — duckdb-serving has no row policy (AMD-07 D3),
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.semantic_customer AS
SELECT
  c.brand_id,
  c.brain_id,
  c.customer_ref,
