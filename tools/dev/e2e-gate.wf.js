...
2. python3 db/iceberg/spark/silver/gate_admission_guard_test.py (must exit 0).
3. bash tools/lint/v4-naming-guard.sh (must pass).
4. py_compile every db/iceberg/spark/silver/*.py + bronze_materialize.py.
