...
export function BrandSwitcher() {
  ...
  // NOTE: brand archive/delete is intentionally NOT available from the switcher.
  // The switcher is for switching only; archiving + restoring lives in
  // Settings → Archived brands. This keeps a destructive, easy-to-misclick action
  // out of the high-frequency navigation surface.
