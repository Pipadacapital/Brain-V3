-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_silver_shipment
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_silver_shipment; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_silver_shipment AS
SELECT
  brand_id,
  order_id,
  source,
