-- SPEC:D.2 / §1.11.1 — Spark-maintained pre-agg for interactive metric aov @ grain=day.
...
-- SPEC:D.2 / §1.11.1 — refresh (idempotent full rebuild) for iceberg.brain_serving.preagg_aov_day. Run by the Spark refresh loop.
INSERT OVERWRITE iceberg.brain_serving.preagg_aov_day
SELECT
    brand_id,
