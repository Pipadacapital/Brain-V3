-- SPEC:D.2 / §1.11.1 / AUD-SL-10 — ATOMIC DuckDB materialization for iceberg.brain_serving.preagg_gross_revenue_day.
...
DELETE FROM iceberg.brain_serving.preagg_gross_revenue_day;

INSERT INTO iceberg.brain_serving.preagg_gross_revenue_day
SELECT
    brand_id,
