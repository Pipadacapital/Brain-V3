-- ============================================================
-- Brain V4 — Trino serving VIEW: mv_gold_journey_paths
--
-- Brain V4 serving runs over TRINO (Iceberg). This view is the thin serving
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_journey_paths;
-- with the Trino default catalog = iceberg that resolves to
-- iceberg.brain_serving.mv_gold_journey_paths. brand_id is the tenant key; the
...
-- ============================================================
CREATE OR REPLACE VIEW iceberg.brain_serving.mv_gold_journey_paths AS
SELECT
  brand_id,
  path_signature,
  path_length,
