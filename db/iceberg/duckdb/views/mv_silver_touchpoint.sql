-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_silver_touchpoint
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_silver_touchpoint; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_silver_touchpoint AS
SELECT
  brand_id,
  brain_anon_id,
  touch_seq,
