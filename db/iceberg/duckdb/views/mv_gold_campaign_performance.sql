-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_campaign_performance
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_campaign_performance; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_campaign_performance AS
SELECT
  brand_id,
  platform,
  campaign_id,
