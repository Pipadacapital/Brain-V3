-- ============================================================
-- SPEC: A.2.2 / A.1.5 — SANCTIONED identity accessor (DuckDB serving): identity_asof
--
-- The BI-TEMPORAL point-in-time / replay view of silver_identity_map (AMD-07). Serving exposes no
-- parameterized accessor, so identity_asof is a documented VIEW that EXPOSES ALL FOUR temporal columns
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.identity_asof AS
SELECT
  brand_id,
  identifier_type,
  identifier_hash,
