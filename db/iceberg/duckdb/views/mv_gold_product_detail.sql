-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_product_detail
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_product_detail; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_product_detail AS
SELECT
  brand_id,
  product_id,
  product_title,
