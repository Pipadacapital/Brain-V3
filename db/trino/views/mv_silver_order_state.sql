-- ============================================================
-- Brain V4 — Trino serving VIEW: mv_silver_order_state
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_silver_order_state;
-- with the Trino default catalog = iceberg that resolves to
-- iceberg.brain_serving.mv_silver_order_state. brand_id is the tenant key; the
-- ${BRAND_PREDICATE} seam injects brand_id = ? at read time.
-- ============================================================
CREATE OR REPLACE VIEW iceberg.brain_serving.mv_silver_order_state AS
SELECT
  brand_id,
  order_id,
  brain_id,
