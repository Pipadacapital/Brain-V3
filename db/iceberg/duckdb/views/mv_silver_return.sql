-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_silver_return  (SR-10)
--
...
--
-- No money. Grain (brand_id, order_id). The metric-engine reads this as the two-part
-- name brain_serving.mv_silver_return; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_silver_return AS
SELECT
  brand_id,
  order_id,
  source,
