-- SPEC:D.2 / §1.11.1 — Spark-maintained pre-agg for interactive metric gross_revenue @ grain=month.
...
-- SPEC:D.2 / §1.11.1 — refresh (idempotent full rebuild) for iceberg.brain_serving.preagg_gross_revenue_month. Run by the Spark refresh loop.
INSERT OVERWRITE iceberg.brain_serving.preagg_gross_revenue_month
SELECT
    brand_id,
