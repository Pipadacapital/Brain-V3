-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_marketing_attribution
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_marketing_attribution; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_marketing_attribution AS
SELECT
  brand_id,
  credit_id,
  order_id,
