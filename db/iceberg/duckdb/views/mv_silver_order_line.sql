-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_silver_order_line
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_silver_order_line; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_silver_order_line AS
SELECT
  brand_id,
  order_id,
  line_index,
