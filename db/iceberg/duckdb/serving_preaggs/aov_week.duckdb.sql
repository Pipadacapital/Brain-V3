-- SPEC:D.2 / §1.11.1 / AUD-SL-10 — ATOMIC DuckDB materialization for iceberg.brain_serving.preagg_aov_week.
...
DELETE FROM iceberg.brain_serving.preagg_aov_week;

INSERT INTO iceberg.brain_serving.preagg_aov_week
SELECT
    brand_id,
