-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_attribution_credit
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_attribution_credit; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_attribution_credit AS
SELECT
  brand_id,
  credit_id,
  order_id,
