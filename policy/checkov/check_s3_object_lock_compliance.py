...
on purpose=audit and purpose=bronze buckets.
"""
...
class S3ObjectLockComplianceCheck(BaseResourceCheck):
    ...
    retention on buckets tagged purpose=audit or purpose=bronze.
    ...
    def __init__(self):
        name = "NN-4: S3 purpose=audit/bronze must use Object Lock COMPLIANCE mode + 7yr retention"
        id = "CKV_BRAIN_2"
    ...
    def scan_resource_conf(self, conf: dict[str, Any]) -> CheckResult:
        ...
        # The bucket tag check (purpose=audit/bronze) is enforced at the plan level
