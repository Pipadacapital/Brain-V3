  ...
  metrics: [
    {
      ...
      howComputed: 'Repeat customers ÷ all customers, from your order history; shows a dash when there are no customers yet.',
    },
    {
      name: 'Cohort size',
      definition: 'New customers first acquired in that calendar month.',
      howComputed: 'Each customer is counted in the month of their first order.',
    },
    {
      ...
      howComputed: 'Cohort lifetime orders ÷ cohort size, calculated exactly; shows a dash when the cohort is empty.',
    },
    {
      name: 'Lifetime value',
      definition: 'Total confirmed revenue generated by that cohort to date.',
      howComputed: 'Added up from the cohort’s orders, always within one currency.',
    },
    {
      ...
      howComputed: '(Cohort lifetime orders − cohort size) ÷ cohort lifetime orders, calculated exactly. Shows a dash when the cohort has no orders yet.',
    },
    {
      name: 'Value share (heatmap)',
      definition: 'Each cohort’s share of the total lifetime value across all cohorts — which acquisition months drive the value.',
      howComputed: 'Cohort value ÷ total value across all cohorts, calculated exactly. Shows a dash when total value is zero.',
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      body: 'The median days between a customer’s 1st and 2nd order, plus a breakdown across day bands (0-7 / 8-14 / 15-30 / 31-60 / 61-90 / 90+ days), from your order history. Single-order customers are excluded from the median. The median shows “—” when no one has come back yet (never a made-up number).',
    },
  ],
  refreshCadence:
    'These figures refresh on the regular analytics cycle. Each read carries a real served-at time, so the freshness badge is never made up.',
  sources: [
    'Your order history, grouped by each customer’s first-purchase month',
    'Customer repeat-purchase records',
  ],
};
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <MetricCard
          label={<MetricTitle label="Repeat-purchase rate" help="The share of your customers who came back and bought more than once." />}
        ...
        />
        <MetricCard
          label={<MetricTitle label="Cohorts tracked" help="How many monthly groups of first-time customers we are following over time." />}
        ...
        />
        <MetricCard
          label={<MetricTitle label="Customers tracked" help="Customers with at least one order that we can follow for repeat behaviour." />}
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <MetricCard
          label={<MetricTitle label="Median days to 2nd order" help="Half of your repeat customers placed their second order within this many days." />}
          value={median != null ? Number(BigInt(median)).toLocaleString('en-IN') : undefined}
          unit={median != null ? 'days' : undefined}
          icon={<Hourglass />}
        />
        <MetricCard
          label={<MetricTitle label="Repeat customers" help="Customers who have placed a second order." />}
                ...
                {users.users.map((u) => (
                  <TableRow key={u.customer_key}>
                    ...
                    <TableCell
                      ...
                      title={u.lifetime_value_minor == null ? 'No purchases recorded yet' : undefined}
                    >
