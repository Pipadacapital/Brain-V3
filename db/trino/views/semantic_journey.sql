...
-- column semantics to iceberg.brain_serving.mv_journey_events_current (the Wave-B serving view).
--
...
-- ============================================================
CREATE OR REPLACE VIEW iceberg.brain_serving.semantic_journey AS
SELECT
  brand_id,
  brain_id,
  touchpoint_id,
