/**
 * serving-brand-sentinel.test.ts — static guard for the positional brand-binding invariant
 * (AUD-ARCH-013).
 *
 * THE INVARIANT: withServingBrand/withSilverBrand replace the FIRST ${BRAND_PREDICATE} sentinel
