-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_retention
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_retention; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_retention AS
SELECT
  brand_id,
  cohort_month,
  currency_code,
