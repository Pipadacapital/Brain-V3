...
enable_guardduty         = false        # HELD (AUD-COST 2026-07-15, owner decision) — off for cost. Was true; drifted back via a promotion/back-merge, re-held. Flip true to re-enable (~single-digit $/mo).
