-- SPEC:D.2 / §1.11.1 — Spark-maintained pre-agg for interactive metric cm2 @ grain=week.
...
-- SPEC:D.2 / §1.11.1 — refresh (idempotent full rebuild) for iceberg.brain_serving.preagg_cm2_week. Run by the Spark refresh loop.
INSERT OVERWRITE iceberg.brain_serving.preagg_cm2_week
SELECT
    brand_id,
