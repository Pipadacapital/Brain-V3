-- SPEC:D.2 / §1.11.1 — Spark-maintained pre-agg for interactive metric net_revenue @ grain=week.
...
-- SPEC:D.2 / §1.11.1 — refresh (idempotent full rebuild) for iceberg.brain_serving.preagg_net_revenue_week. Run by the Spark refresh loop.
INSERT OVERWRITE iceberg.brain_serving.preagg_net_revenue_week
SELECT
    brand_id,
