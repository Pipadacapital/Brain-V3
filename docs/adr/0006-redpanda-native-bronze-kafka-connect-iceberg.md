...
> **ANNOTATION (2026-07-05): D1 RE-REINSTATED by [ADR-0010](0010-kafka-connect-iceberg-bronze-reinstated.md)** — the K2b withdrawal below was itself reversed: Kafka Connect is again the sole Bronze landing writer, and the Spark-SS landing jobs named in this note were removed from the codebase at the executed cutover. The note is kept verbatim as decision history.
>
