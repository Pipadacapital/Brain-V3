-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_cac
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_cac; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_cac AS
SELECT
  brand_id,
  acquisition_month,
  currency_code,
