-- ============================================================
-- Brain V4 FIREHOSE — Trino serving VIEW: mv_silver_marketing_spend_by_demographic
--
...
-- ============================================================
CREATE OR REPLACE VIEW iceberg.brain_serving.mv_silver_marketing_spend_by_demographic AS
SELECT
  brand_id,
  spend_event_id,
  platform,
