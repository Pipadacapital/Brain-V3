-- ============================================================
-- Brain V4 — DuckDB serving VIEW: mv_gold_cod_rto
--
...
--
-- The metric-engine reads this as the two-part name brain_serving.mv_gold_cod_rto; in
...
-- ============================================================
CREATE OR REPLACE VIEW brain_serving.mv_gold_cod_rto AS
SELECT
  brand_id,
  currency_code,
  cod_orders,
